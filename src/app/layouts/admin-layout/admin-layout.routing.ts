...
export const AdminLayoutRoutes: Routes = [
  ...
  { path: "payment_types", component: PaymentTypesComponent },
  {
    path: "payment_types/:id/edit",
    component: PaymentTypesDetailComponent
  },
  { path: "payment_types/new", component: PaymentTypesDetailComponent },

  { path: "physiotherapists", component: PhysiotherapistsComponent },
  {
    path: "physiotherapists/:id/edit",
    component: PhysiotherapistDetailComponent
  },
  {
  ...
  {
    path: "work_results/:id/edit",
    component: WorkResultDetailComponent
  },
