...
export class DataService {
  ...
  public getAll(params?: string, query?: string) {
    ...
    return this.httpClient.get(this.baseUrl + filter + include, {
  ...
  public get(id: number, params: string) {
    ...
    return this.httpClient.get(this.baseUrl + "/" + id + include, {
      headers: this.getAuthHeader()
    });
  }
  ...
  public search(queryParams: string, includeParams: string) {
    ...
    return this.httpClient.get(
      this.baseUrl + "/" + queryString + includeString,
      { headers: this.getAuthHeader() }
    );
  }

  public create(resource: any) {
    return this.httpClient.post(this.baseUrl.toString(), resource, {
      headers: this.getAuthHeader()
    });
  }
  ...
  public update(resource: any) {
    return this.httpClient.put(
      this.baseUrl.toString() + "/" + resource.id,
      resource,
      { headers: this.getAuthHeader() }
    );
  }
